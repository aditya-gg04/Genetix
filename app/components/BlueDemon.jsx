...
export const BlueDemon = forwardRef(function BlueDemon(props, ref) {
  const group = useRef()
  ...
  useEffect(() => {
    ...
    if (actions && Object.keys(actions).length > 0) {
      ...
      console.log('BlueDemon actions:', actions)
    }
  }, [actions])
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="CharacterArmature">
          <skinnedMesh
            name="BlueDemon"
            geometry={nodes.BlueDemon.geometry}
            material={materials.Atlas}
            skeleton={nodes.BlueDemon.skeleton}
          />
